...
def ops(ip):    
    ...
    r = requests.get("https://internetdb.shodan.io/"+ip)
    ...
    try:
        AllData["Ports"]=data["ports"]
        for port in AllData["Ports"]:
            try:
                AllData["Service"].append(NmapTable[str(port)])
            except:
                AllData["Service"].append("")
    except:
