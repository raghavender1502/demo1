...
def get_details(host):
    ...
    if is_good_certificate == False:
        response = {
            ...
            "moreInfo": "TLSA record which is a part of DANE, is not configured for the domain name. DNS-based Authentication of Named Entities (DANE) is a protocol to allow X.509 certificates, commonly used for Transport Layer Security (TLS), to be bound to DNS names using Domain Name System Security Extensions (DNSSEC). Please refer to RFC 6698 : https://datatracker.ietf.org/doc/html/rfc6698 for additional information."
        }
        ...
        response = {
            ...
            "moreInfo": "TLS DNSA Record is correctly configured for the domain name. Please refer to RFC 6698 : https://datatracker.ietf.org/doc/html/rfc6698 for additional information."
        }    
